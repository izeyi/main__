...
onload = function() {
  ...
  document.querySelector('#back').onclick = function() {webview.goBack()};

  document.querySelector('#forward').onclick = function() {webview.goForward()};

  document.querySelector('#home').onclick = function() {document.querySelector('webview').src = 'http://yun.greatorange.cn/articleSet/'};

  document.querySelector('#reload').onclick = function() { isLoading ? webview.stop() : webview.reload()};

  document.querySelector('#reload').addEventListener('webkitAnimationIteration',function(){if(!isLoading)document.body.classList.remove('loading')});

  document.querySelector('#location-form').onsubmit = function(e) {e.preventDefault();navigateTo(document.querySelector('#location').value)};
  ...
  if (typeof(webview.setZoom) == "function" && typeof(webview.find) == "function") {
    ...
    document.querySelector('#zoom-in').onclick = function(e) {e.preventDefault(); increaseZoom();}

    document.querySelector('#zoom-out').onclick = function(e) {e.preventDefault(); decreaseZoom();}
    ...
    document.querySelector('#match-case').onclick = function(e) {e.preventDefault();
    ...
    document.querySelector('#find-backward').onclick = function(e) {e.preventDefault();
      webview.find(document.forms['find-form']['find-text'].value,{backward: true, matchCase: findMatchCase});
    }

    document.querySelector('#find-form').onsubmit = function(e) {e.preventDefault();
      webview.find(document.forms['find-form']['find-text'].value,{matchCase: findMatchCase});
    }
...
function handleLoadStop(event) { isLoading = false;}
...
function closeZoomBox() {document.querySelector('#zoom-box').style.display = 'none';}

function openFindBox() {document.querySelector('#find-box').style.display = 'block';ct(document.forms['find-form']['find-text'].sele);}
