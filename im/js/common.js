...
$("#dialog").append('<div class="message_item default"><div class="content"><div class="msg_userinfo"><span class="msg_time">'+data['time']+' '+DE_JSON(decodeURIComponent(data['client_name']))["nickname"]+' 进入了会议室!</span></div></div><div style="clear:both;"></div></div>');
...
msg(DE_JSON(decodeURIComponent(data['from_client_name']))["nickname"]+' 离开了会议室!')
