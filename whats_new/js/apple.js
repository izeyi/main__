    ...
    var b, a = new Swiper(".apple-banner .swiper-container", {
            ...
            onProgress: function (a) {
                ...
                for (b = 0; b < a.slides.length; b++) {
                    for (c = a.slides.eq(b),
                    	d = c[0].progress,
                    	d > 0 ? (e = 1 * d * a.width,scale = 1  * d, d > 1 && (scale = 1), txtPositionX = 0, txtPositionY = 30 * d + "px") : (e = 0, scale = 1,txtPositionX = 1e3 * -d + "px",txtPositionY = 0),
                        f = c.find(".txt"), g = 0; g < f.length; g++)
            ...
            onSetTransition: function (a, b) {
                var c, d, e;
                for (c = 0; c < a.slides.length; c++) for (slide = a.slides.eq(c),
                	slide.transition(b), d = slide.find(".txt"),
                	e = 0; e < d.length; e++) d.eq(e).transition(b)
            },
